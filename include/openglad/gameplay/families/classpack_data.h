...
//   radar_ping:       oversized pulsing SDL blip + bold curses glyph (#209 —
//                     mode objectives like the soccer/basketball balls)
struct ClasspackPresentation {
    ...
    std::optional<bool> radar_ping;           // oversized pulsing blip (#209)
};
