...
- Activation: `census_mask` `mode_match.lua:54-73`; `own_roster_activation`
  `:93-130` (2026-08-18: the solo/roster arms are gone — one backfill rule,
  request = explicit N or the authored count at Auto; see the D26 addendum).
