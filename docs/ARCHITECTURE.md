...
four originals) is generated by `tools/ctf_mapgen` via `scripts/generate_ctf_campaign.sh`, which
also emits the team-tinting sprites `pix/flag.png`/`pix/ctfpoint.png`
