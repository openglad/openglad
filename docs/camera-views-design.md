...
| Inset geometry | GameplayUI-canvas coords, `w = ui_w*3/10`, `h = ui_h*3/10`, min 96×60, centered | D2, pinned by review |
...
- Geometry (pinned): **GameplayUI canvas coordinates** (fixed classic density — immune to world-canvas zoom recomposition): `w = ui_w * 3/10`, `h = ui_h * 3/10` (min 96×60), centered: `x = (ui_w - w)/2`, `y = (ui_h - h)/2`.
