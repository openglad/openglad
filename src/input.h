...
// SDL 2 compat
    ...
    #define KEYSTATE_LEFT SDLK_LEFT
    #define KEYSTATE_RIGHT SDLK_RIGHT
    #define KEYSTATE_PAGEDOWN SDLK_PAGEDOWN
    #define KEYSTATE_PAGEUP SDLK_PAGEUP
    #define KEYSTATE_RETURN SDLK_RETURN
    ...
    #define KEYSTATE_RCTRL SDLK_RCTRL
