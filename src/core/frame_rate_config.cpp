...
// field directly here; we anchor on the literal 72 instead. 72 is the
// default *render*-frame rate; sim cadence is independent and governed by
// world.timer_wait (master semantics).
