...
button yes_or_no_buttons[] =
    {
        button("yes", "YES", KEYSTATE_UNKNOWN,  70, 130, 50, 20, YES_OR_NO, YES, MenuNav::Right(1)),
        button("no", "NO", KEYSTATE_UNKNOWN,  320-50-70, 130, 50, 20, YES_OR_NO, NO, MenuNav::Left(0))
    };

button no_or_yes_buttons[] =
    {
        button("no", "NO", KEYSTATE_UNKNOWN,  70, 130, 50, 20, YES_OR_NO, NO, MenuNav::Right(1)),
        button("yes", "YES", KEYSTATE_UNKNOWN,  320-50-70, 130, 50, 20, YES_OR_NO, YES, MenuNav::Left(0))
    };

button popup_dialog_buttons[] =
    {
        button("ok", "OK", KEYSTATE_ESCAPE,  160 - 25, 130, 50, 20, YES_OR_NO, YES, MenuNav::None())
    };
...
void view_team(short left, short top, short right, short bottom)
{
	...
	for(i=0; i < myscreen->save_data.team_size; i++)
	{
		...
		if (ourteam[i])
		{
			...
			message = std::format("{:2d}", ourteam[i]->get_level());
...
Sint32 create_train_menu(Sint32 arg1)
{
	...
	while ( !(retvalue & EXIT) )
	{
        ...
        // Level
        message = std::format("{}", current_guy->get_level());
...
#define WR(p,m) if (m[1] != ' ') mytext.write_xy(DETAIL_MM, DETAIL_LD(p), m, RED, 1); else mytext.write_xy(DETAIL_MM, DETAIL_LD(p), m, DARK_BLUE, 1)
   ...
   while ( !(retvalue & EXIT) )
   {
       ...
       {
           case FAMILY_SOLDIER:
               message = std::format("Level {} soldier has:", thisguy->get_level());
               ...
               break;
           case FAMILY_BARBARIAN:
               message = std::format("Level {} barbarian has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               ...
               break;
           case FAMILY_ELF:
               message = std::format("Level {} elf has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               ...
               break;
           case FAMILY_ARCHER:
               message = std::format("Level {} archer has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               // Level 1 things
               WL(2, " Fire Arrows     ");
               ...
               break;
           case FAMILY_MAGE:
               message = std::format("Level {} Mage has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               // Level 1 things
               ...
               break;
           case FAMILY_ARCHMAGE:
               message = std::format("Level {} ArchMage has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               // Level 1 things
               WL(2, " Teleport/Marker ");
           ...
           case FAMILY_CLERIC:
               message = std::format("Level {} Cleric has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               // Level 1 things
               WL(2, " Heal            ");
               ...
               break;
           case FAMILY_DRUID:
               message = std::format("Level {} Druid has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               // Level 1 things
               WL(2, " Plant Tree      ");
               ...
               break;
           case FAMILY_THIEF:
               message = std::format("Level {} Thief has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               // Level 1 things
               WL(2, " Drop Bomb       ");
               ...
               break;
           case FAMILY_ORC:
               message = std::format("Level {} Orc has:", thisguy->get_level());
               mytext.write_xy(DETAIL_LM+1, DETAIL_LD(0)+1, message.c_str(), 10, 1);
               mytext.write_xy(DETAIL_LM, DETAIL_LD(0), message.c_str(), DARK_BLUE, 1);
               // Level 1 things
               WL(2, " Howl            ");
