...
void replace_loaded_world_state(LevelRuntimeData* level, GameWorld& loaded_world)
{
    ...
    dst.ctf_requested_bot_squad = loaded_world.ctf_requested_bot_squad;
    dst.ctf_requested_bot_level = loaded_world.ctf_requested_bot_level;
...
void LevelRuntimeData::attach_world(GameWorld* world)
{
    ...
    if (old_world != nullptr)
    {
        ...
        next_world->ctf_requested_bot_squad =
            old_world->ctf_requested_bot_squad;
        next_world->ctf_requested_bot_level =
            old_world->ctf_requested_bot_level;
        ...
        old_world->respawn = og::sim::RespawnState{};
