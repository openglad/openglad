...
void radar::start()
{
    start(&og::runtime::current_session->myscreen_->world());
}

void radar::start(og::gameplay::GameWorld* data)
{
...
short radar::draw()
{
    return draw(&og::runtime::current_session->myscreen_->world());
}

short radar::draw(og::gameplay::GameWorld* data)
{
...
void radar::update()
{
    update(&og::runtime::current_session->myscreen_->world());
}

// This function re-initializes the radar map data.  Do not
// call it often, as it is very slow ..
void radar::update(og::gameplay::GameWorld* data)
{
	short temp, i, j;
