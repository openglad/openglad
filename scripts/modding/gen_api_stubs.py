...
def generate(repo_root: Path) -> str:
    ...
    out.append("-- team bands, and is the whole table -- the preset names")
    out.append("-- retired with the BOTS wheel, whose five-value FILL")
    out.append("-- replacement names nothing a campaign owns.")
