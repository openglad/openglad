...
def generate(repo_root: Path) -> str:
    ...
    out.append("-- presence -- it must return an EXPLICIT wheel code, 1-5")
    out.append("-- (D1: 1 NONE, 2 WEAK, 3 FAIR, 4 STRONG, 5 BRUTAL), with")
    out.append("-- explicit stored values coming back unchanged; the")
    out.append("-- default itself is not an answer. packs/core")
