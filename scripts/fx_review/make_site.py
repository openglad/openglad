...
MENUS = [
    ...
    ("menu_difficulty", "Difficulty submenu walkthrough",
     "The DIFFICULTY door on the main menu opens the new submenu: Difficulty (Battle/Skirmish/Slaughter), Respawns (Off/Heroes/Everyone/Team 1 Heroes), Respawn Delay (Normal/Fast/Slow), Permadeath (On/Off) and Generators (Normal/Calm/Frenzy). Every row is cycled through a full loop — labels change live and every setting ends where it started."),
