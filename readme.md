...
* [Gladiator ver. 3.8 Readme](#gladiator-version-38-readme) (written by FSGames)
    ...
    * [[3] How to play -- a brief tutorial](#3-how-to-play----a-brief-tutorial)
        * [A) The Picker](#a-the-picker)
        * [B) The Scenarios](#b-the-scenarios)
        * [C) Continuing the cycle](#c-continuing-the-cycle)
    * [[4] Hints and Tips](#4-hints-and-tips)
    * [[6] Credits](#6-credits)
* [Gladiator (not Openglad) revision history](#gladiator-not-openglad-revision-history)
...
needs to be set in your autoexec.bat.  It should like: `BLASTER=A220 I5 D1 T2` or something similar.  Gladiator may, unfortunately, freeze up
...
See [AUTHORS](AUTHORS) file for Openglad contributors.
