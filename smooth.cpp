...
long smoother::query_x_y(long x, long y)
{
  ...
  // Check boundaries ..
  if ( (x < 0) || (y < 0) ) return PIX_GRASS1;

  if ( (x >= maxx) || (y >= maxy) ) return PIX_GRASS1;
...
long smoother::smooth(long x, long y)
{
  ...
  switch (here) // switch on genre
  {
   ...
   case TYPE_GRASS_DARK:  // Shadowed grass
    if (around == TO_AROUND ) // all around
    {
      switch (random(4))
      {
        case 0: newvalue = PIX_GRASS_DARK_1; break;
        case 1: newvalue = PIX_GRASS_DARK_2; break;
        case 2: newvalue = PIX_GRASS_DARK_3; break;
        case 3: newvalue = PIX_GRASS_DARK_4; break;
      }
    }
        ...
        && (upright != TYPE_TREES && upright != TYPE_WALL) ) // act as right edge
    {
      switch (random(2))
      {
        case 0: newvalue = PIX_GRASS_DARK_R1; break;
        case 1: newvalue = PIX_GRASS_DARK_R2; break;
      }
      break;
    }
        ...
        && (up == TYPE_TREES || up == TYPE_WALL) ) // act as bottom middle
    {
      switch (down) // are we a bottom middle, or center? depends..
      {
        ...
        case TYPE_COBBLE:
          switch (random(2))
          {
            case 0: newvalue = PIX_GRASS_DARK_B1; break;
            case 1: newvalue = PIX_GRASS_DARK_B2; break;
          }
   ...
   case TYPE_WATER:
    if ( (around == TO_AROUND ) // all around
      ...
      switch (random(3))
      {
       case 0: newvalue = PIX_WATER1; break;
       case 1: newvalue = PIX_WATER2; break;
       case 2: newvalue = PIX_WATER3; break;
      }
      ...
      switch (random(2))
      {
       case 0:  newvalue = PIX_WATERGRASS_LL; break;
       case 1:  newvalue = PIX_WATERGRASS_LR; break;
      }
    else if (around == (TO_DOWN) )
      switch (random(2))
      {
       case 0:  newvalue = PIX_WATERGRASS_UL; break;
       case 1:  newvalue = PIX_WATERGRASS_UR; break;
      }
    else if (around == (TO_LEFT) )
      switch (random(2))
      {
       case 0:  newvalue = PIX_WATERGRASS_UR; break;
       case 1:  newvalue = PIX_WATERGRASS_LR; break;
      }
      ...
      {
       case 0:  newvalue = PIX_WATERGRASS_UL; break;
       case 1:  newvalue = PIX_WATERGRASS_LL; break;
      }
    else  // Water default:
   ...
   case TYPE_TREES:
    if (around == TO_AROUND ) // all around
    {
      if (downright != TYPE_TREES || upright != TYPE_TREES)
       ...
       switch (random(3))
       {
        case 0: newvalue = PIX_TREE_M1; break;
        case 1: newvalue = PIX_TREE_M1; break;
        case 2: newvalue = PIX_TREE_M1; break;
       }
    }
    else if (around == (TO_LEFT | TO_RIGHT | TO_DOWN)) // == top middle
   ...
   case TYPE_DIRT:
    if (around == TO_AROUND ) // all around
      switch (random(3))
      {
       case 0: newvalue = PIX_DIRT_1; break;
       case 1: newvalue = PIX_DIRT_1; break;
       case 2: newvalue = PIX_DIRT_1; break;
      }
    else if (around == (TO_LEFT | TO_RIGHT | TO_DOWN)) // == top middle
      newvalue = PIX_DIRT_1;
    else if (around == (TO_UP | TO_DOWN | TO_LEFT)) // right middle
   ...
   case TYPE_DIRT_DARK:
    if (around == TO_AROUND ) // all around
      switch (random(3))
      {
       case 0: newvalue = PIX_DIRT_DARK_1; break;
       case 1: newvalue = PIX_DIRT_DARK_1; break;
       case 2: newvalue = PIX_DIRT_DARK_1; break;
      }
    else if (around == (TO_LEFT | TO_RIGHT | TO_DOWN)) // == top middle
  ...
  case TYPE_COBBLE: // cobblestone
    switch (random(4))
    {
      case 0: newvalue = PIX_COBBLE_1; break;
      case 1: newvalue = PIX_COBBLE_2; break;
      case 2: newvalue = PIX_COBBLE_3; break;
      case 3: newvalue = PIX_COBBLE_4; break;
    }
    break;
