...
C) Continuing the cycle
  ...
  (in the registered version) in the "300-range" levels.  To select
  these levels from the registered version, click the "Set Level" button
  and choose "300" to begin playing.  Also, this version of Gladiator
  ships with 4 "pre-made" saved-games, which are ready to begin
  the player-versus-player leves automatically.
...
[5] Registering Gladiator (do it do it do it do it)
  ...
  we'd REALLY be your bestest friends, and for just $10.00 or $15.00,
  you get:
  ...
  Registering Gladiator costs $10 if you register over the Internet,
  or if you include your e-mail address with your registration and
  download the registered version from our web site.  If you need
  us to send you a physical floppy disk and documentation through
  U.S. mail, the cost is $15 (to cover our extra costs).

  You can register Gladiator RIGHT NOW over the Internet, and
  be playing it in minutes!  If you have a credit card and
  ...
  If you send a check, please make it out to Tom Ricket,
