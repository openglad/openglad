...
void test_level_data_batch2_misc_uncovered_paths_smoke()
{
    ...
    TEST_ASSERT(og::runtime::current_session->myscreen_->world().remaining_foes(a) >= 0, "remaining_foes should run");
...
void test_level_data_range_helpers_positive_selection_paths()
{
    ...
    walker* friend_weapon = og::runtime::current_session->myscreen_->world().add_ob(Order::Weapon, FAMILY_ARROW);
...
void test_level_data_round7a_title_reader_and_error_wrappers()
{
    ...
    og::runtime::current_session->myscreen_->world().delete_objects();
    og::runtime::current_session->myscreen_->world().id = 9403;
    og::runtime::current_session->myscreen_->level_file_metadata_.grid_file = "round7a";
    og::runtime::current_session->myscreen_->world().title = "Round7A";
    og::runtime::current_session->myscreen_->world().create_new_grid();
    std::filesystem::create_directories("temp/scen");
    (void)og::runtime::current_session->myscreen_->save_level();
    const auto err = og::runtime::current_session->myscreen_->last_level_io_error_;
    TEST_ASSERT(err == og::data::LevelFileIoError::None || err == og::data::LevelFileIoError::OpenWriteFailed,
                "save_level wrapper should return a concrete io error");
}
...
void test_level_data_round6_remove_ob_and_wrapper_paths()
{
    ...
    TEST_ASSERT(og::runtime::current_session->myscreen_->save_level(),
                "save_level should succeed");
    TEST_ASSERT_EQ((int)og::data::LevelFileIoError::None,
                   (int)og::runtime::current_session->myscreen_->last_level_io_error_,
                   "last_level_io_error should be None on successful save");
}
...
void test_level_data_round6_passable_wall4_and_water_weapon_paths()
{
    ...
    og::runtime::current_session->myscreen_->world().grid.h = 1;
    og::runtime::current_session->myscreen_->world().pixmaxx = GRID_SIZE;
    og::runtime::current_session->myscreen_->world().pixmaxy = GRID_SIZE;
...
void test_level_data_round11_wrappers_draw_and_query_grid_entry_paths()
{
    ...
    og::runtime::current_session->myscreen_->level_file_metadata_.description.push_back("alpha");
    og::runtime::current_session->myscreen_->level_file_metadata_.description.push_back("beta");
    TEST_ASSERT(og::runtime::current_session->myscreen_->get_description_line(1) == "beta", "second description line should be readable");
    TEST_ASSERT(og::runtime::current_session->myscreen_->get_description_line(5).empty(), "out-of-range description line should be empty");
    ...
    og::runtime::current_session->myscreen_->world().grid.frames = 1;
    og::runtime::current_session->myscreen_->world().grid.w = 2;
    og::runtime::current_session->myscreen_->world().grid.h = 2;
    og::runtime::current_session->myscreen_->world().pixmaxx = GRID_SIZE * 2;
...
void test_level_data_round13_find_helpers_selection_and_filters()
{
    ...
    walker* actor = og::runtime::current_session->myscreen_->world().add_ob(Order::Living, FAMILY_SOLDIER);
    walker* foe_far = og::runtime::current_session->myscreen_->world().add_ob(Order::Living, FAMILY_ORC);
    walker* foe_near = og::runtime::current_session->myscreen_->world().add_ob(Order::Generator, FAMILY_TOWER);
    walker* friend_living = og::runtime::current_session->myscreen_->world().add_ob(Order::Living, FAMILY_ARCHER);
    walker* friend_weapon = og::runtime::current_session->myscreen_->world().add_ob(Order::Weapon, FAMILY_ARROW);
...
void test_level_data_round14_find_helper_exclusion_branches()
{
    ...
    walker* actor = og::runtime::current_session->myscreen_->world().add_ob(Order::Living, FAMILY_SOLDIER);
    walker* hidden_foe = og::runtime::current_session->myscreen_->world().add_ob(Order::Living, FAMILY_ORC);
    walker* dead_blood = og::runtime::current_session->myscreen_->world().add_fx_ob(Order::Treasure, FAMILY_STAIN);
...
void test_level_data_round16_remaining_foes_and_object_passable_collision_paths()
{
    ...
    TEST_ASSERT_EQ(1, (int)og::runtime::current_session->myscreen_->world().remaining_foes(actor),
...
static void clear_stale_hook(og::gameplay::GameWorld*)
{
...
void test_level_data_round17_grid_resize_campaign_wrappers_and_delete_object_hooks()
{
    ...
    og::runtime::current_session->myscreen_->world().delete_objects();
    og::runtime::current_session->myscreen_->world().grid.data[0] = PIX_TREE_M1;
    const int old_w = og::runtime::current_session->myscreen_->world().grid.w;
    const int old_h = og::runtime::current_session->myscreen_->world().grid.h;

    walker* keep = og::runtime::current_session->myscreen_->world().add_ob(Order::Living, FAMILY_SOLDIER);
