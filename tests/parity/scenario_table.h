...
inline constexpr ScenarioSpec kScenarios[] = {
    ...
    {"family_soldier_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_soldier, std::size(kFamilySpawns_complete_soldier), 0, false, true, Exercises::None, kFacts_family_soldier_scen99, std::size(kFacts_family_soldier_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_SOLDIER expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_elf_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_elf, std::size(kFamilySpawns_complete_elf), 0, false, true, Exercises::None, kFacts_family_elf_scen99, std::size(kFacts_family_elf_scen99), kMut_family_spawn_identity_elf, "05a family_spawns[]=FAMILY_ELF expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_archer_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_archer, std::size(kFamilySpawns_complete_archer), 0, false, true, Exercises::None, kFacts_family_archer_scen99, std::size(kFacts_family_archer_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_ARCHER expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_mage_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_mage, std::size(kFamilySpawns_complete_mage), 0, false, true, Exercises::None, kFacts_family_mage_scen99, std::size(kFacts_family_mage_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_MAGE expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_skeleton_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_skeleton, std::size(kFamilySpawns_complete_skeleton), 0, false, true, Exercises::None, kFacts_family_skeleton_scen99, std::size(kFacts_family_skeleton_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_SKELETON expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_cleric_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_cleric, std::size(kFamilySpawns_complete_cleric), 0, false, true, Exercises::None, kFacts_family_cleric_scen99, std::size(kFacts_family_cleric_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_CLERIC expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_fireelemental_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_fireelemental, std::size(kFamilySpawns_complete_fireelemental), 0, false, true, Exercises::None, kFacts_family_fireelemental_scen99, std::size(kFacts_family_fireelemental_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_FIREELEMENTAL expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_faerie_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_faerie, std::size(kFamilySpawns_complete_faerie), 0, false, true, Exercises::None, kFacts_family_faerie_scen99, std::size(kFacts_family_faerie_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_FAERIE expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_slime_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_slime, std::size(kFamilySpawns_complete_slime), 0, false, true, Exercises::None, kFacts_family_slime_scen99, std::size(kFacts_family_slime_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_SLIME expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_small_slime_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_small_slime, std::size(kFamilySpawns_complete_small_slime), 0, false, true, Exercises::None, kFacts_family_small_slime_scen99, std::size(kFacts_family_small_slime_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_SMALL_SLIME expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_medium_slime_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_medium_slime, std::size(kFamilySpawns_complete_medium_slime), 0, false, true, Exercises::None, kFacts_family_medium_slime_scen99, std::size(kFacts_family_medium_slime_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_MEDIUM_SLIME expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_thief_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_thief, std::size(kFamilySpawns_complete_thief), 0, false, true, Exercises::None, kFacts_family_thief_scen99, std::size(kFacts_family_thief_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_THIEF expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_ghost_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_ghost, std::size(kFamilySpawns_complete_ghost), 0, false, true, Exercises::None, kFacts_family_ghost_scen99, std::size(kFacts_family_ghost_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_GHOST expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_druid_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_druid, std::size(kFamilySpawns_complete_druid), 0, false, true, Exercises::None, kFacts_family_druid_scen99, std::size(kFacts_family_druid_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_DRUID expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_orc_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_orc, std::size(kFamilySpawns_complete_orc), 0, false, true, Exercises::None, kFacts_family_orc_scen99, std::size(kFacts_family_orc_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_ORC expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_big_orc_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_big_orc, std::size(kFamilySpawns_complete_big_orc), 0, false, true, Exercises::None, kFacts_family_big_orc_scen99, std::size(kFacts_family_big_orc_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_BIG_ORC expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_barbarian_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_barbarian, std::size(kFamilySpawns_complete_barbarian), 0, false, true, Exercises::None, kFacts_family_barbarian_scen99, std::size(kFacts_family_barbarian_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_BARBARIAN expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_archmage_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_archmage, std::size(kFamilySpawns_complete_archmage), 0, false, true, Exercises::None, kFacts_family_archmage_scen99, std::size(kFacts_family_archmage_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_ARCHMAGE expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_golem_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_golem, std::size(kFamilySpawns_complete_golem), 0, false, true, Exercises::None, kFacts_family_golem_scen99, std::size(kFacts_family_golem_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_GOLEM expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    ...
    {"family_giant_skeleton_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_giant_skeleton, std::size(kFamilySpawns_complete_giant_skeleton), 0, false, true, Exercises::None, kFacts_family_giant_skeleton_scen99, std::size(kFacts_family_giant_skeleton_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_GIANT_SKELETON expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
    {"family_tower1_scen99", "scen/scen1.fss", 0x00000042u, kInputsFamilyCompleteness, std::size(kInputsFamilyCompleteness), 600, CompareMode::SemanticParity, false, kFamilySpawns_complete_tower1, std::size(kFamilySpawns_complete_tower1), 0, false, true, Exercises::None, kFacts_family_tower1_scen99, std::size(kFacts_family_tower1_scen99), kMut_family_spawn_identity, "05a family_spawns[]=FAMILY_TOWER1 expected_facts[]=WalkerFamilyCount,WalkerOfTeamAlive,WalkerPositionMoved,EventKindAtLeast" },
