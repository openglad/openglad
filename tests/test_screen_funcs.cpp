...
void test_screen_find_in_range_basic()
{
    ...
    TEST_ASSERT(target != nullptr, "create target should succeed");
	    ...
	    og::runtime::current_session->myscreen_->level_data.oblist.push_back(std::move(target));

	    Sint32 howmany = 0;
	    auto result = og::runtime::current_session->myscreen_->find_in_range(og::runtime::current_session->myscreen_->level_data.oblist, 500, &howmany, seeker.get());
...
void test_screen_find_in_range_out_of_range()
{
    ...
    TEST_ASSERT(target != nullptr, "create target should succeed");
	    ...
	    Sint32 howmany = 0;
	    auto result = og::runtime::current_session->myscreen_->find_in_range(og::runtime::current_session->myscreen_->level_data.oblist, 5, &howmany, seeker.get());
...
void test_screen_find_foes_in_range()
{
    ...
    seeker->setxy(100, 100);
	    ...
	    Sint32 howmany = 0;
	    auto result = og::runtime::current_session->myscreen_->find_foes_in_range(og::runtime::current_session->myscreen_->level_data.oblist, 500, &howmany, seeker.get());
...
void test_screen_find_friends_in_range()
{
    ...
    seeker->setxy(100, 100);
	    ...
	    og::runtime::current_session->myscreen_->level_data.oblist.push_back(std::move(friend_w));

	    Sint32 howmany = 0;
	    auto result = og::runtime::current_session->myscreen_->find_friends_in_range(og::runtime::current_session->myscreen_->level_data.oblist, 500, &howmany, seeker.get());
...
void test_screen_query_grid_passable_center()
{
    ...
    w->setxy(100, 100);
    bool passable = og::runtime::current_session->myscreen_->query_grid_passable(100, 100, w.get());
...
void test_screen_query_grid_passable_out_of_bounds()
{
    ...
    bool passable = og::runtime::current_session->myscreen_->query_grid_passable(-10, -10, w.get());
...
void test_screen_find_far_foe_smoke()
{
    ...
    walker* result = og::runtime::current_session->myscreen_->find_far_foe(w.get());
...
void test_screen_find_near_foe_smoke()
{
    ...
    walker* result = og::runtime::current_session->myscreen_->find_near_foe(w.get());
    (void)result;
...
void test_screen_query_passable_smoke()
{
    ...
    bool p = og::runtime::current_session->myscreen_->query_passable(100, 100, w.get());
    (void)p;
