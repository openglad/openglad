...
void test_screen_save_data_score()
{
    ...
    TEST_ASSERT(og::runtime::current_session->myscreen_->save_data.m_score[0] > old_score, "score should increase");
...
void test_screen_endgame_clears_mission_score_after_payout()
{
    ...
    TEST_ASSERT_EQ(1250, static_cast<int>(og::runtime::current_session->myscreen_->save_data.m_totalscore[0]),
                   "win should add current mission score exactly once");
...
void test_screen_multiview_lifecycle_paths()
{
    ...
    TEST_ASSERT(og::runtime::current_session->myscreen_->viewob[0] != nullptr && og::runtime::current_session->myscreen_->viewob[1] != nullptr,
                "ready_for_battle(2) should initialize two views");

    og::runtime::current_session->myscreen_->ready_for_battle(3);
    TEST_ASSERT(og::runtime::current_session->myscreen_->viewob[0] != nullptr && og::runtime::current_session->myscreen_->viewob[1] != nullptr && og::runtime::current_session->myscreen_->viewob[2] != nullptr,
                "ready_for_battle(3) should initialize three views");

    og::runtime::current_session->myscreen_->reset(4);
    TEST_ASSERT(og::runtime::current_session->myscreen_->viewob[0] != nullptr && og::runtime::current_session->myscreen_->viewob[1] != nullptr &&
                og::runtime::current_session->myscreen_->viewob[2] != nullptr && og::runtime::current_session->myscreen_->viewob[3] != nullptr,
