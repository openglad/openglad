...
MASS_TEST(test_mass_screen_find_in_range, {
    ...
    Sint32 n = 0;
    walker* w = add_living(0);
    (void)og::runtime::current_session->myscreen_->find_in_range(og::runtime::current_session->myscreen_->world().oblist, 32, &n, w);
    reset_level_state();
});
...
MASS_TEST(test_mass_screen_find_foes_in_range, {
    ...
    walker* w = add_living(0);
    (void)add_living(1);
    (void)og::runtime::current_session->myscreen_->find_foes_in_range(og::runtime::current_session->myscreen_->world().oblist, 64, &n, w);
    reset_level_state();
});
...
MASS_TEST(test_mass_screen_find_friends_in_range, {
    ...
    walker* w = add_living(0);
    (void)add_living(0);
    (void)og::runtime::current_session->myscreen_->find_friends_in_range(og::runtime::current_session->myscreen_->world().oblist, 64, &n, w);
    reset_level_state();
});
...
MASS_TEST(test_mass_screen_find_foe_weapons_in_range, {
    ...
    (void)og::runtime::current_session->myscreen_->find_foe_weapons_in_range(og::runtime::current_session->myscreen_->world().weaplist, 64, &n, w);
    reset_level_state();
});
